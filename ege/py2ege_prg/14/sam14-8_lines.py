...
"""
def clusterNo( x, y ):
  return 0 if y > 0.32*x+2 and y < 0.32*x+6 else \
         1 if y < 0.32*x-6.5 and not (x > 14 and y < -5) else \
         2 if y < -x+9 and y > -x+3 and y < 6 else \
         3 if y < -x+17 and y > -x+11 else \
        -1
