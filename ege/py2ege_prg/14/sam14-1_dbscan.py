"""
В файле data14-1_simple.txt записаны координаты точек, составляющие три кластера. Известно,
...
Метод: DBSCAN (нерекурсивный).

Ответ: 25130 43931
"""
data = []
for s in open('data/data14-1_simple.txt'):
  x, y = s.replace(',','.').split()
